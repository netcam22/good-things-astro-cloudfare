// .wrangler/tmp/bundle-8C3Mc0/checked-fetch.js
...
// .wrangler/tmp/pages-WkXabh/functionsWorker-0.030206599132562184.mjs
...
async function handleRequest2(context) {
  ...
  const asset = await context.env.ASSETS.fetch(url);
  const assetText = await asset.text();
  const newAssetText = assetText.replace("Lorem", randomFact);
...
// .wrangler/tmp/bundle-8C3Mc0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8C3Mc0/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.030206599132562184.js.map
